<div class="col-md-3 newsfeed-left-side sticky-top shadow-sm sidebar">
        ...
        <ul class="list-group list-group-flush newsfeed-left-sidebar">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center sd-active">
                <a href="index.html" class="sidebar-item"><img
                        src="{{ asset('assets/images/icons/left-sidebar/newsfeed.png') }}" alt="newsfeed" />
                    News Feed</a>
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center">
                <a href="messages.html" class="sidebar-item"><img
                        src="{{ asset('assets/images/icons/left-sidebar/message.png') }}" alt="message" />
                    Messages</a>
                <span class="badge badge-primary badge-pill">2</span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center">
                <a href="groups.html" class="sidebar-item"><img
                        src="{{ asset('assets/images/icons/left-sidebar/group.png') }}" alt="group" />
                    Groups</a>
                <span class="badge badge-primary badge-pill">17</span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center">
                <a href="events.html" class="sidebar-item"><img
                        src="{{ asset('assets/images/icons/left-sidebar/event.png') }}" alt="event" />
                    Events</a>
                <span class="badge badge-primary badge-pill">3</span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center">
                <a href="saved.html" class="sidebar-item"><img
                        src="{{ asset('assets/images/icons/left-sidebar/saved.png') }}" alt="saved" />
                    Saved</a>
                <span class="badge badge-primary badge-pill">8</span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center">
                <a href="find-friends.html" class="sidebar-item"><img
                        src="{{asset('assets/images/icons/left-sidebar/find-friends.png')}}" alt="find-friends" />
                    Find Friends</a>
                <span class="badge badge-primary badge-pill"><i class="bx bx-chevron-right"></i></span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center">
                <a href="matches.html" class="sidebar-item"><img src="{{asset('assets/images/icons/left-sidebar/matches.png')}}"
                        alt="matches" />
                    Matches</a>
                <span class="badge badge-primary badge-pill"><i class="bx bx-chevron-right"></i></span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center">
                <a href="teams.html" class="sidebar-item"><img src="{{asset('assets/images/icons/left-sidebar/team.png')}}"
                        alt="find-friends" />
                    Argon For Teams</a>
                <span class="badge badge-primary badge-pill"><i class="bx bx-chevron-right"></i></span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center newsLink">
                <a href="https://github.com/ArtMin96/argon-social" target="_blank" class="sidebar-item"><img
                        src="{{asset('assets/images/icons/left-sidebar/news.png')}}" alt="find-friends" />
                    News</a>
                <span class="badge badge-primary badge-pill"><i class="bx bx-chevron-right"></i></span>
            </li>
        </ul>
